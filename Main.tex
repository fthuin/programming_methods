...
\usetikzlibrary{automata, arrows, chains, decorations, positioning, shapes, fit, backgrounds}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{center}
      \inference{\{p\} S_{1} \{ r \}, \{r\} S_{2} \{q\}}{\{ p \} \{ S_1 S_2 \} \{q\}}
  \end{center}
  ...
  \input{res/data_stores.tex}

  % TODO(Florian Thuin): reprendre à partir d'ici
  ...
  \inference{p \Rightarrow wlp(S, q)}
  {\{p\}S\{q\}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \inference{[p] \{S_1 \ldots S_n\} [q]}
  {[p]\textrm{ par } S_1\textrm{ and }\ldots\textrm{ and }S_n [q]}

  \inference{[p_1] S_1 [q_1], \ldots, [p_n] S_n [q_n]}
